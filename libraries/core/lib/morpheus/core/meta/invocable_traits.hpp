...
///     Ensures an callable is invocable in a noexcept context.
...
///     Ensures an callable is invocable as a constant.
template <typename Callable, typename... Args>
...
///     Ensures an callable is invocable with given arguments and return type.
